    ...
    <html lang="en" translate="no">
      ...
      >
        <div className="min-h-screen flex flex-col md:flex-row">
          {/* Sidebar */}
          <aside
            className={`bg-white shadow-lg w-64 p-6 fixed md:static z-50 inset-y-0 left-0 transform transition-transform duration-300 ease-in-out
        ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}
          ...
          <div className="flex-1 flex flex-col ml-0 min-h-screen">
            {/* Topbar */}
            <header className="bg-white shadow px-4 py-3 flex items-center justify-between md:justify-center">
              <Button
                variant="ghost"
                size="icon"
                className="md:hidden"
              ...
              <span className="hidden md:block text-slate-600 font-medium">Welcome back, Admin!</span>
            </header>
